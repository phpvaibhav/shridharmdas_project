...
class Donationtype_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = 'donationtype';
    var $column_order = array('p.typeId','p.name','p.status'); //set column field database for datatable orderable
    var $column_sel = array('p.typeId','p.name','p.status','(case when (p.status = 0) 
    ...
    var $order = array('p.typeId'=> 'DESC');  // default order
    var $where = array();
    var $group_by = 'p.typeId'; 
    ...
    private function _get_query()
    {
        ...
        $this->db->from('donationtype as p');
