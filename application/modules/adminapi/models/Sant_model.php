...
class Sant_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = 'sant_maharaj';
    var $column_order = array('p.santId','p.name','p.status'); //set column field database for datatable orderable
    var $column_sel = array('p.santId','p.name','p.about','p.status','(case when (p.status = 0) 
    ...
    var $order = array('p.santId'=> 'DESC');  // default order
    var $where = array();
    var $group_by = 'p.santId'; 
    ...
    private function _get_query()
    {
        ...
        $this->db->from('sant_maharaj as p');
