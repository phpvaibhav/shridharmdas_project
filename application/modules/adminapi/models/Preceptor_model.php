...
class Preceptor_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = 'preceptor';
    var $column_order = array('p.preId','p.name','p.status'); //set column field database for datatable orderable
    var $column_sel = array('p.preId','p.name','p.about','p.status','(case when (p.status = 0) 
    ...
    var $order = array('p.preId'=> 'DESC');  // default order
    var $where = array();
    var $group_by = 'p.preId'; 
