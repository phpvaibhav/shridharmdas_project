...
class Pachkan_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = 'pachkan';
    var $column_order = array('p.pachkanId','p.name','p.status'); //set column field database for datatable orderable
    var $column_sel = array('p.pachkanId','p.name','p.description','p.file','p.status','(case when (p.status = 0) 
    ...
    var $order = array('p.pachkanId'=> 'DESC');  // default order
    var $where = array();
    var $group_by = 'p.pachkanId'; 
