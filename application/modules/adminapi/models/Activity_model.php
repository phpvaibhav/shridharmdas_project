...
class Activity_model extends CI_Model {
    ...
    private function _get_query()
    {
        ...
        $this->db->from('activity_log as al');
           $this->db->join('admin as a','a.id=al.adminId');
        $this->db->join('users as u','u.id=al.userId');
        $this->db->join('admin_role as r','r.roleId=a.roleId');
