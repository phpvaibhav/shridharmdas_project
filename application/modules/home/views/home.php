<?php $frontend_assets =  base_url().'frontend_assets/';?>
  ...
  <section id="intro">
    ...
    <div class="owl-carousel">
      <div class="item section-padding" style="background-image:url(<?= $frontend_assets.'images/slider/Group-316.png'; ?>);width: 100%;background-size:100% 100%;background-repeat:no-repeat;">
        <div class="container">
