    ...
    <div class="owl-carousel">
      <div class="item section-padding" style="background-image:url(<?= $frontend_assets.'images/slider/Group-317.png'; ?>);width: 100%;background-size:100% 100%;background-repeat:no-repeat;">        <div class="container">
          ...
          <a href="<?= base_url(); ?>user-step-1" class="btn dark-btn tilak-top-btn">जनगणना फ़ॉर्म</a>
            ...
            <div class="item section-padding" style="background-image:url(<?= $frontend_assets.'images/slider/Group-329-2.png'; ?>);width: 100%;background-size:100% 100%;background-repeat:no-repeat;">
        <div class="container">
          <div class="intro_text white_text">
            <!--  <h1>Shinto Believes in Kami</h1> -->
            <h1></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 col-md-12">
          <div class="about-us-content text-center content-home">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="features_wrap custom-sm-mb features-after-none">
              ...
              <p class="mb-0">आचार्य प्रवर, शासन गौरव, आत्मार्थीपूज्य गुरुदेव श्री उमेशमुनिजी म.सा.‘अणु’ का जीवन-परिचय के लिए क्लिक करे</p>
            </div>
          </a>
          </div>
          <div class="col-lg-4 col-md-6">
