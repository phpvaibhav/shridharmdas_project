      ...
      <div class="item section-padding" style="background-image:url(<?= $frontend_assets.'images/slider/Group-317.png'; ?>);width: 100%;background-size:100% 100%;background-repeat:no-repeat;">
        <div class="container">
          ...
          <a href="<?= base_url(); ?>user-step-1" class="btn dark-btn tilak-top-btn">User Form</a>
            ...
            <div class="item section-padding" style="background-image:url(<?= $frontend_assets.'images/slider/Group-31.png'; ?>);width: 100%;background-size:100% 100%;background-repeat:no-repeat;">
        <div class="container">
          <div class="intro_text white_text">
            <!--  <h1>Shinto Believes in Kami</h1> -->
            <h1></h1>
