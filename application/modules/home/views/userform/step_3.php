            ...
            <div class="row">
              <div class="col-md-8 offset-col-2 mx-auto d-block login-page">
                <div class="login-page">
                    ...
                    <?php }else{ ?>
                      <a class="color-litegreen color-nirdes" href="javascript:void(0);" type="button"  data-toggle="modal" data-target=".bd-example-modal-lg">Instructions for filling the form </a>
                       <?php }?>

                    </p>
                </div>
                
                <form id="user-add-step-3" method="post" class="login-form-t" novalidate="novalidate" action="userStep3"  novalidate="novalidate" autocomplete="off" enctype="multipart/form-data" >
                  <div class="row">
                      <div class="col-md-12">
                          <header>
