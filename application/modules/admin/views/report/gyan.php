				...
				<!-- 	<span class="widget-icon"> <i class="fa fa-users"></i> </span> -->
					...
					<div class="jarviswidget-ctrls" role="menu">   
						<!-- <a href="<?= base_url('sangh-users-incomplete');?>" class="button-icon" rel="tooltip" title="Users incomplete"><i class="glyphicon glyphicon-ban-circle"></i> Incomplete users&nbsp;&nbsp; </a> -->
						 ...
						 <a class="btn btn-warning pull-right"  target="_blank" href="<?= base_url('admin/report/mpdf/').$id_gyan;?>">Download PDF</a>  <!-- <a class="btn btn-warning pull-right"  target="_blank" href="<?= base_url('admin/report/pgpdf/').$id_gyan;?>">Download PDF G</a>  -->
