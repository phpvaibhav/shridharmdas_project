...
<?php endif; ?>
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover dataTables-example-list" width="100%" data-list-url = "adminapi/sanghusers/list" data-id ="trash" data-no-record-found = "<?= lang('No_Record_found'); ?>" >
								<thead>			                
									<tr>
									<tr>
