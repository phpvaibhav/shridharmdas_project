...
class Admin extends Common_Back_Controller {
    ...
    public function dashboard() {
        ...
        $data['users']      = 0;//$this->common_model->get_total_count('users');
        $data['preceptor']      = 0;//$this->common_model->get_total_count('users');
        $data['union']      = 0;//$this->common_model->get_total_count('users');
        $data['office']      = 0;//$this->common_model->get_total_count('users');
